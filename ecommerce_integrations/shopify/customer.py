...
class ShopifyCustomer(EcommerceCustomer):
    ...
    def sync_customer(self, customer: dict[str, Any]) -> None:
        ...
        address_data = customer.get("default_address")
        ...
        phone = (
            ...
            else address_data.get("phone")
        )
        territory = address_data.get("city")
        super().sync_customer(customer_name, customer_group, phone, territory)
